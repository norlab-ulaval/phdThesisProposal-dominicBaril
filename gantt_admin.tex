...
\begin{ganttchart}[
    ...
    \ganttbar{Final results chapter}{2}{3}
    \ganttbar[inline, bar label font/.append=\color{white}]{}{2}{3}\\
    ...
    \ganttbar{Dynamic modeling}{1}{1}
    \ganttbar[inline, bar label font/.append=\color{white}]{}{1}{1}\\
    
    \ganttbar{Adaptive modeling}{2}{2}
    \ganttbar[inline, bar label font/.append=\color{white}]{}{2}{2}\\
    
    \ganttbar{\emph{Opt.} Extra paper}{3}{4}
    \ganttbar[inline, bar label font/.append=\color{white}]{}{3}{4}\\
    
    \ganttmilestone{Opt. Extra paper submitted}{4}\\
    
    %--------------------------------------       
    \ganttgroup{\emph{ICRA 2024}}{1}{5} \\ 
    
    \ganttbar{Paper corrections}{1}{1}
    \ganttbar[inline, bar label font/.append=\color{white}]{}{1}{1}\\
    
    \ganttmilestone{Re-submission}{1}\\
